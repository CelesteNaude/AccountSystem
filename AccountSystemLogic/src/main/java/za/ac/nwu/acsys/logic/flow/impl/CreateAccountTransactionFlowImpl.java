...
public class CreateAccountTransactionFlowImpl implements CreateAccountTransactionFlow {
    ...
    public AccountTransactionDto create(AccountTransactionDto transactionDto) {
        ...
        transactionDto.setTransactionId(null);//if transactionId was populated
        ...
        AccountInfo accountInfo = fetchAccountInfoFlow.getAccountInfoDbEntityById(transactionDto.getAccountInfo());
    ...
    @Override
    public AccountTransactionDto add(AccountTransactionDto transactionDto) {
        LOGGER.info("The input object was {}", transactionDto);
